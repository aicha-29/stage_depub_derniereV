...
import ProjectModal from "../../components/admin/ProjectModel";
  ...
  return (
    <div className="projets">
      <div className="header-section">
        <h1 className="projet-page-title">Tous les Projets</h1>
      </div>
...
>>>>>>> 60710b6d54c5e787e27567e0a08902e5df448068
      ...
      {isModalOpen && selectedProject && (
        <ProjectModal 
          ...
          isReadOnly={true} // Mode lecture seule pour les managers
        />
      )}
    </div>
  );
